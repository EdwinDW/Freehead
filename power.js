...
var Icon = {
	...
	setTexture: function (d, c, b) {
		...
		if (b.indexOf("?") != -1) {
			...
			a.backgroundImage = "url(http://db.freedomwow.ru/images/icons/" + Icon.sizes[c] + "/" + b.toLowerCase() + ".jpg)"
		}
...
var Tooltip = {
	...
	setIcon: function (a) {
		Tooltip.prepare();
		if (a) {
			Tooltip.icon.style.backgroundImage = "url(http://db.freedomwow.ru/images/icons/medium/" + a.toLowerCase() + ".jpg)";
