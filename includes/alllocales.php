...
switch($_SESSION['locale'])
{
	...
	case '8':
		mass_define(array(
			...
			'LOCALE_NPCTYPE_BEAST' 			=> 'Животные',
			'LOCALE_NPCTYPE_DRAGONKIN' 		=> 'Драконы',
			'LOCALE_NPCTYPE_DEMON' 			=> 'Демоны',
			'LOCALE_NPCTYPE_ELEMENTAL' 		=> 'Элементали',
			'LOCALE_NPCTYPE_GIANT' 			=> 'Великаны',
			'LOCALE_NPCTYPE_UNDEAD' 		=> 'Нежить',
			'LOCALE_NPCTYPE_HUMANOID' 		=> 'Гуманоиды',
			'LOCALE_NPCTYPE_CRITTER' 		=> 'Существа',
			'LOCALE_NPCTYPE_MECHANIC' 		=> 'Механизмы',
			'LOCALE_NPCTYPE_UNCATEGORIZED' 	=> 'Разное',
			// player/other
			'LOCALE_NAME'	=> 'имя',
			'LOCALE_CLASS'	=> 'класс',
			'LOCALE_RACE'	=> 'раса',
	...
	default:
		mass_define(array(
			...
			'LOCALE_GBONUS_RESTOREHEALTH'		=>	'Restore %d health per 5 sec.',
			'LOCALE_GBONUS_SPELLPENETRATION'		=>	'Increases the penetrating ability of spells by %d.',
			'LOCALE_GBONUS_HIT_TAKEN_MELEE_RATING'	=>  'Increases your dodge rating by %d.',
			'LOCALE_GBONUS_HIT_TAKEN_SPELL_RATING' =>  'Improves spell hit avoidance rating by %d.',
			'LOCALE_GBONUS_HASTE_MELEE_RATING' =>  'Improves melee haste rating by %d.',
			'LOCALE_GBONUS_RANGED_ATTACK_POWER' =>  'Increases ranged attack power by %d.',
			'LOCALE_COOLDOWN'						=>	'cooldown',
